...
def Ejecutar_estrategias(df, estrategia, *args):
    ...
    df_con_estrategia = estrategia(df, *args)

    return df_con_estrategia
...
def Estrategia_01(df, umbral_compra, take_profit, stop_loss):
    ...
    print(lista_desempeños)
    return desempeño_separado
...
take_profit = 4.5
stop_loss = -1.5
df_estrategias, df_desempeños, desempeño, lista_desempeños, desempeño_separado = Ejecutar_estrategias(df_procesado, Estrategia_01, umbral_compra, take_profit, stop_loss)
df_estrategias.to_excel('data/precios_procesados_SQL.xlsx')
df_desempeños.to_excel('data/desempeños.xlsx')
print(round(desempeño, 2))
print(lista_desempeños)
print(round(desempeño_separado, 2))
exit()
'''
'''
...
take_profit = 4.5
stop_loss = -1.5
desempeño_separado = Ejecutar_estrategias(df_procesado, Estrategia_01, umbral_compra, take_profit, stop_loss)
desempeño_separado = 'ℹ️ Desempeño separado: ' + str(round(desempeño_separado*100,1)) + '% ℹ️'


# Genero alertas y envío
alertas = Generar_alertas(df_procesado, 2)
Enviar_mensaje(resultado_final, BOT_TOKEN, CHAT_ID)
Enviar_mensaje(desempeño_separado, BOT_TOKEN, CHAT_ID)
