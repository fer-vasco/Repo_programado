...
horas = [11, 12, 13]
mensaje = Ejecutar_estrategias(df_procesado, Estrategia_02, 3, 4, -1.5, horas)
print(mensaje)
exit()
'''
...
stop_loss = -1.5
horas = [11, 12, 13]
mensaje = Ejecutar_estrategias(df_procesado, Estrategia_02, umbral_compra, take_profit, stop_loss, horas)
